...
let dependencies: [PackageDescription.Package.Dependency] = [
    ...
    .package(url: "https://github.com/CSCIX65G/SwiftyLinkerKit.git", .branch("swift5Small")),
...
/* For Large Shield only.  Uncomment this and comment out the above declaration
 let dependencies: [PackageDescription.Package.Dependency] = [
     .package(url: "https://github.com/CSCIX65G/smoke-framework.git", .branch("swift5")),
     .package(url: "https://github.com/CSCIX65G/Shell.git", .branch("swift5")),
